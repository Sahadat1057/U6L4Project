...
class ConverterRunner {
    public static void main(String[] args) {
        ...
        System.out.println("--------------------------------");
        System.out.println("Option 1. Convert a number of base 2, 8, 10 or 16");
        System.out.println("Option 2. Convert a decimal number to any base from 1 - 64");
        ...
        if (choice.equals("1")) {
            ...
            while (NumberConverter.checkInputs(Integer.parseInt(base), number) == false) {
                System.out.println(number + " is not a number in base " + base);
            ...
            System.out.print("Enter your number in decimal form: ");
            String number = s.nextLine();
            ...
            System.out.println(NumberConverter.convertToBase64(Integer.parseInt(number), Integer.parseInt(base)));
        }
    }
